    ...
    return `<!doctype html>
      <html lang="en">
        <head>
          ...
          <meta property="og:image" content="images/seo_rappi.jpg">   
          <meta name="apple-mobile-web-app-title" content="DoDoma">
          <meta name="dodoma-web" content="3.13.2">
          <meta name="msapplication-TileImage" content="https://images.rappi.com/web/rappi_favicon.png">   
          <meta name="description" content="Доставка маркетплэйс и что-то такое ДоДома">
          <meta property="og:title" content="Маркетплэйс ДоДома Томск">
          <meta property="og:description" content="Доставка Маркетплэйс Томск.">
          ...
          <script type="text/javascript" charset="UTF-8" src="js/geometry.js"></script>
          ...
          <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
              ...
              })(window,document,'script','dataLayer','GTM-WJZNQMX');
          </script>
