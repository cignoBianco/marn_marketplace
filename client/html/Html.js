...
<span  className="app-span-container ng-star-inserted"><app-page-not-found>   
    ...
    <div  className="ng-star-inserted"><app-banner><div  className="banner-container"><div  className="banner guest-banner">         <img  className="img-1 ng-star-inserted" src="images/sports.png"/><img  className="img-2 ng-star-inserted" src="images/pharmacy.png"/>
  <img  className="img-3 ng-star-inserted" src="/images/burguer.png"/>
  <img  className="img-4 ng-star-inserted" src="./images/mrs.png"/>      <div  className="title">   <h1  className="bold ng-star-inserted" style={{"font-size": "40px"}}>Marketplace что-то такое    </h1></div></div>   
    ...
    <img  className="img-5 ng-star-inserted" src="public/images/fashion.png"/><img  className="img-6 ng-star-inserted" src="images/markets.png"/></div></app-banner>
