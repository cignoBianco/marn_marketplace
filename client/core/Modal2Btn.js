...
export default function Modal2Btn({hide}) {
    ...
    return (
        ...
        <h3 className={classes.label}>Длинный заголовок</h3>
            ...
            <div style={{display: 'flex', justifyContent: 'space-between'}}>
                <Button className={classes.Button2} style={{padding:'7px 40px'}} >Отказ</Button>
                <Button className={classes.Button} style={{padding:'7px 40px'}} >Подтверждение</Button>
            </div>  
        </div>
    )
}