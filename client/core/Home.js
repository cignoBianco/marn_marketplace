    ...
    return (
      ...
      <div className={classes.root}>
        ...
        <app-container ng-version="8.2.14">
                ...
                <div  className="stores-list-cont hidden-mobile">
                    <div  className="stores ng-star-inserted">
                      <ul id="categories-sub-menu">
                          ...
                          <li  className="normal-stores ng-star-inserted">      <a href="/shops/all"  className="ng-star-inserted"> Restaurantes </a>   </li>
          ...
          <div id="app-container"  className="app-container home header-active with-search-bar">
              <div  className="total-width pt-75">
                          ...
                          <div  className="banner-container">
                            ...
                            <div  className="location-container ng-star-inserted">
                                <div  className="location-input border-input">
                                  <i  className="iconf-pointer-secondary-fill pointer"></i>
                                  <app-search-autocomplete  className="input"><input id="autocomplete-address-input" type="text" placeholder="Введите свой адрес"  className="ng-untouched ng-pristine ng-valid pac-target-input" autoComplete="off" /><span  className="no-search-results-content"></span></app-search-autocomplete>
                                </div>
                                <button  className="primary-button-filled"> Искать </button>
                            </div>
                            <img  className="img-5 ng-star-inserted" src={fashionImg}/>
                            <img  className="img-6 ng-star-inserted" src={marketImg}/>
                          </div>
                      </app-banner>
                      <div  className="home-container">
                          <app-cpgs-container _nghost-ng-web-c43>
                            <div  _ngcontent-ng-web-c43="true"  className="cpgs-container">
                                <h4  _ngcontent-ng-web-c43="true"  className="subtitle"> Выберите подходящую категорию </h4>
                                <h2  _ngcontent-ng-web-c43="true"  className="title"> Категории </h2>
                                <ul  _ngcontent-ng-web-c43="true"  className="cpgs-grid">
                            ...
                            <li  _ngcontent-ng-web-c43="true"  className="store-item ng-star-inserted"><app-cpg-card  _ngcontent-ng-web-c43="true" _nghost-ng-web-c29>         <a  _ngcontent-ng-web-c29="true"  className="cpg-card ng-star-inserted" title="Restaurantes" href="/shops/all"><div  _ngcontent-ng-web-c29="true"  className="cpg-img-container" style={{"backgroundColor": "rgb(255, 131, 86)"}}>
                    ...
                    <div  className="head-footer" id="head-footer">
                      <div>
                          ...
                          <div  className="cont-text">
                            <span>Экономь время</span>
                            <p>Доставка до дома меньше чем за час</p>
                          </div>
                      </div>
                      <div>
                          <div  className="cont-img">
                      ...
                      <div>
                          ...
                          <div  className="cont-text">
                            ...
                            <p>Caso o seu produto chegue em mal estado, você não pagará por ele!</p>
                          </div>
                      </div>
                    </div>
                </div>
                <div  className="footer-cont">
                    <div  className="container info-footer" id="info-footer">
                      <div>
                          <h6>Categorias</h6>
                          <ul  className="list-footer">
                            <li  className="ng-star-inserted">      <a href="/lojas/tipo/supermercados"  className="ng-star-inserted"><span>Supermercados</span></a>   </li>
                            <li  className="ng-star-inserted">      <a href="/shops/all"  className="ng-star-inserted"><span>Restaurantes</span></a>   </li>
                            <li  className="ng-star-inserted">      <a href="/lojas/tipo/adidasbotao"  className="ng-star-inserted"><span>Adidas</span></a>   </li>
                            <li  className="ng-star-inserted">      <a href="/lojas/tipo/bebidas-24"  className="ng-star-inserted"><span>Bebidas</span></a>   </li>
                            <li  className="ng-star-inserted">      <a href="/lojas/tipo/farmacia"  className="ng-star-inserted"><span>Farmácia 24h</span></a>   </li>
                            <li  className="ng-star-inserted">      <a href="/lojas/tipo/express-big"  className="ng-star-inserted"><span>Express</span></a>   </li>
                            <li  className="ng-star-inserted">      <a href="/lojas/tipo/nespresso-button"  className="ng-star-inserted"><span>Nespresso </span></a>   </li>
                            <li  className="ng-star-inserted">      <a href="/lojas/techguru"  className="ng-star-inserted"><span>Sos iphone</span></a>   
                            </li>
                            <li  className="ng-star-inserted">         <a href="/mall"  className="ng-star-inserted"><span>Lojas</span></a>      </li>
                            <li  className="ng-star-inserted">      <a href="/lojas/tipo/carrefourbotao"  className="ng-star-inserted"><span>Carrefour</span></a>   </li>
                            <li  className="ng-star-inserted">      <a href="/parafuzo"  className="ng-star-inserted"><span>Limpeza</span></a>   </li>
                            <li  className="ng-star-inserted">      <a href="/lojas/tipo/petzbotao"  className="ng-star-inserted"><span>Petz</span></a>   </li>
                            <li  className="ng-star-inserted">      <a href="/getninjas"  className="ng-star-inserted"><span>Serviços</span></a>   </li>
                            <li  className="ng-star-inserted">      <a href="/lojas/tipo/natal-2018"  className="ng-star-inserted"><span>Lojas</span></a>   </li>
                          </ul>
                      </div>
                      <div  className="center-content">
                          <h6>Informação de interesse</h6>
                          <ul  className="list-footer footer-links">
                            <li  className="ng-star-inserted"><a rel="nofollow" target="_blank" href="https://legal.rappi.com/brazil/termos-e-condicoes-de-uso-da-plataforma-rappi/"><span> Termos e Condições </span></a></li>
                            <li  className="ng-star-inserted"><a rel="nofollow" target="_blank" href="https://soyrappi.com/?utm_source=appuser&amp;utm_medium=applk&amp;utm_campaign=rt"><span> Quero ser Rappi Entregador </span></a></li>
                            <li  className="ng-star-inserted"><a rel="nofollow" target="_blank" href="https://www.rappi.com/jobs/"><span> Trabalhe conosco </span></a></li>
                            <li  className="ng-star-inserted"><a rel="nofollow" target="_blank" href="https://www.rappi.com.br/blog/como-funciona-a-rappi/"><span> Como funciona a Rappi </span></a></li>
                            <li  className="ng-star-inserted"><a rel="nofollow" target="_blank" href="https://surveys.rappi.com/inbound"><span> Registre seu restaurante </span></a></li>
                            <li  className="ng-star-inserted"><a rel="nofollow" target="_blank" href="https://surveys.rappi.com/inbound"><span> Venda com a Rappi </span></a></li>
                            <li  className="ng-star-inserted"><a rel="nofollow" target="_blank" href="https://surveys.rappi.com/inbound"><span> Seja Parceiro </span></a></li>
                            <li  className="ng-star-inserted"><a rel="nofollow" target="_blank" href="https://one.rappi.com/"><span> Faça sua marca crescer - RappiOne </span></a></li>
                            <li  className="ng-star-inserted"><a rel="nofollow" target="_blank" href="https://www.rappi.com.br/blog/compras-supermercado-online/"><span> Como fazer compras de supermercados </span></a></li>
                            <li  className="ng-star-inserted"><a rel="nofollow" target="_blank" href="https://legal.rappi.com/brazil/aviso-de-privacidade-e-politicas-de-uso-das-informacao-utilizadas-pela-rappi/"><span> Política de processamento de dados pessoais </span></a></li>
                            <li  className="ng-star-inserted"><a rel="nofollow" target="_blank" href="https://partners.rappi.com/"><span> Portal Restaurantes Parceiros </span></a></li>
                          </ul>
                      </div>
                      <div  className="app-links">
                          <h6>Baixe o aplicativo</h6>
                          <div  className="cont-apps"><a rel="nofollow" target="_blank" href="https://itunes.apple.com/co/app/rappi/id984044296?mt=8">
                            ...
                            <img className="android-img" src={playStore}/></a>
                          </div>
                          <h6  className="follow">Redes sociais</h6>
                          <ul  className="redes">
                            <li><a  className="facebook" rel="nofollow" target="_blank" href="https://www.facebook.com/RappiBrasil/"><i  className="iconf-facebook"></i></a></li>
                            <li><a  className="twitter" rel="nofollow" target="_blank" href="https://twitter.com/rappibrasil?lang=es"><i  className="iconf-twitter"></i></a></li>
                            <li><a  className="instagram" rel="nofollow" target="_blank" href="https://www.instagram.com/rappibrasil/?hl=es"><i  className="iconf-instagram"></i></a></li>
                          </ul>
                          <div  className="partners-info"><a rel="nofollow" target="_blank" href="https://www.truora.com/?utm_source=rappi&amp;utm_medium=home_link&amp;utm_campaign=bottom_image">
                            <img className="truora-img" src={truoraImg}/></a>   
                          </div>
                      </div>
                    </div>
                    <div  className="footer-cont">
                      <div  className="firm-footer" id="firm-footer">
                          <p> © 2020 DoDoma    <span  className="ng-star-inserted"> - DoDoma SPB INTERMEDIAÇÃO DE NEGÓCIOS LTDA., CNPJ 26.900.161/0001-25,  Rua Dr Renato Paes de Barro, 33, Itaim Bibi, São Paulo/SP, Brasil. </span></p>
                      </div>
                    </div>
                </div>
              </footer>
          ...
          <app-order-status-resume  className="home ng-star-inserted">            </app-order-status-resume>
        </app-container>
        <script async src="js/js.js"></script><script src="js/api.js"></script><script src="js/runtime.c6ae727bd39fd1bf6b0f.js" defer></script><script src="js/polyfills-es5.66f25889e6ec334a8f0e.js" noModule defer></script><script src="js/polyfills.93e277369afc6b115767.js" defer></script>
